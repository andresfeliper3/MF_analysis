...
class RegionGenomeManager(GenomeManagerInterface):
    ...
    def calculate_multifractal_analysis_values(self, GCF: str, save_to_db: bool, name: str):
        super().calculate_multifractal_analysis_values(GCF=GCF, save_to_db=save_to_db, name=name)
